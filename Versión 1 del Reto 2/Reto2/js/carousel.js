...
var cta_list = document.querySelectorAll('.cta'); // returns NodeList
var cta_array = [...cta_list]; // converts NodeList to Array

console.log(cta_array);

div_array.forEach(cta => {
